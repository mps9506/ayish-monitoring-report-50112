...
```{r map, fig.width=645/96*0.95, fig.height=834/96*0.95, dpi=96, fig.cap="Map of Ayish Bayou watershed, segments, and monitoring stations.", fig.alt="Map that shows the boundaries of the Ayish Bayou watershed, location of TCEQ stream segments, monitoring stations, and political boundaries."}
...
```{r do, fig.cap="Grab dissolved oxygen samples by (A) station and by (B) date. Dissolved oxygen grab minimum and screening level criterion are indicated by the solid and dashed lines.", fig.alt="Box-plots display the distribution of dissolved oxygen measurements at each site, and a time series plots show the change in dissolved oxygen over the sample period.", fig.width=6, fig.height=8, fig.dpi=200}
p1 <- df |> 
...
```{r fig.alt="Box-plots display the distribution of E. coli concentration at each site, and a time series plots show the change in E. coli concentration over the sample period.", fig.width=6, fig.height=8.25, fig.dpi=200}
p1 <- df |> 
...
```{r nitrate, fig.cap="Grab nitrate-nitrogen samples by (A) station and by (B) date. The 1.95 mg/L screening level is indicated by the dashed line. Censored values are less than the laboratory level of quantification.", fig.alt="Box-plots display the distribution of nitrate concentration at each site, and a time series plots show the change in nitrate concentration over the sample period.", fig.width=6, fig.height=8, fig.dpi=200}
p1 <- df |> 
...
```{r nitrite, fig.cap="Grab nitrite-nitrogen samples by (A) station and by (B) date. Censored values are less than the laboratory level of quantification.", fig.alt="Box-plots display the distribution of nitrite concentration at each site, and a time series plots show the change in nitrite concentration over the sample period.", fig.width=6, fig.height=8, fig.dpi=200}
p1 <- df |> 
...
```{r ammonia, fig.cap="Grab nitrogen-ammonia samples by (A) station and by (B) date. Censored values are less than the laboratory level of quantification.", fig.alt="Box-plots display the distribution of ammonia concentration at each site, and a time series plots show the change in ammonia concentration over the sample period.", fig.width=6, fig.height=8, fig.dpi=200}
p1 <- df |> 
...
```{r kjeldahl, fig.cap="Grab nitrogen-Kjeldahl samples by (A) station and by (B) date. Censored values are less than the laboratory level of quantification.", fig.alt="Box-plots display the distribution of Kjeldahl nitrogen concentration at each site, and a time series plots show the change in Kjeldahl nitrogen concentration over the sample period.", fig.width=6, fig.height=8, fig.dpi=200}
p1 <- df |> 
...
```{r tp, fig.cap="Grab total phosphorus samples by (A) station and by (B) date. The dotted line indicates the 0.69 mg/L screening level. Censored values are less than the laboratory level of quantification.", fig.alt="Box-plots display the distribution of total phosphorus concentration at each site, and a time series plots show the change in total phosphorus concentration over the sample period.", fig.width=6, fig.height=8, fig.dpi=200}
p1 <- df |> 
...
```{r flow, fig.cap=" (A) Histogram of total distribution of all instantaneous streamflow measurements and (B) instantaneous streamflow measurements by date and station.", fig.alt="Histogram displaies the distribution of instantaneous streamflow measurements across all sites, and a time series plots show the change in instantaneous streamflow over the sample period for each site.", fig.width=6, fig.height=8, fig.dpi=200}
